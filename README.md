...
```
- The Forwarder Module will re-create a Rest Request from data received in the `forward` stream and will re-send the event to the HttpEventCollector (HEC) of Splunk.
```bash
